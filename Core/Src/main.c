...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_CPU_Pin|LED_COM_Pin|LED_IN1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_CPU_Pin LED_COM_Pin LED_IN1_Pin */
  GPIO_InitStruct.Pin = LED_CPU_Pin|LED_COM_Pin|LED_IN1_Pin;
